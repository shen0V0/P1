...
<body>
    <div style="width:100%; height:100%; overflow: hidden; position:absolute; min-width:1500px;">
        ...
        if ($PH <= 0) {
            ...
            <div>
                <button class="Next" onclick="location.href = \'\'" style="animation:fadeOut 0s forwards, fadeIn 2s forwards 5s;">Next</button>
            </div></div>';
        } else if ($DH <= 0 && $DC == 1) {
            echo '
            <div class="overlay" style="animation:fadeIn 3s forwards; z-index:20;display:flex;flex-direction:column;" >
        ...
        <div style="width:1550px;">
            <div style="position: relative; z-index:-10;">
                <img src="Forest.png" style="width: 100%; position: absolute; z-index: -1; max-height:95%; min-width:1300px">
                <img src="Grassland.png" style="width: 100%; position: relative; z-index:-2; min-width:1300px">
            </div>
            <img class="monster2" src="Dragon.png">
            ...
            <div class="hp" style="height:150px; overflow:hidden; top: 310px; left: 630px; position: absolute; width: 310px; animation:none;">
                ...
                for ($i = 0; $i < $DH; $i++) {
                    echo '<img src="Heart.png" class="hearts" alt="Heart" style="width:10%">';
                }

                for ($i = $DH; $i < $max_health_D; $i++) {
                    echo '<img src="Empty_Heart.png" class="hearts" alt="Empty Heart" style="width:10%">';
                }
                ?>
            </div>
        </div>
    ...
    <div class="dialoge" style="animation: fadeIn 0s forwards;">
        <div style="flex: 1">
            ...
            <div class="hp" style=" height:150px; left: 250px; animation: none;">
                ...
                for ($i = 0; $i < $PH; $i++) {
                    echo '<img src="Heart.png" class="hearts" alt="Heart" style="width:33%">';
                }

                for ($i = $PH; $i < $MP; $i++) {
                    echo '<img src="Empty_Heart.png" class="hearts" alt="Empty Heart" style="width:33%">';
                }
                ?>
            </div>
        </div>
